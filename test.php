<?php
// make BASE_URL and other constants available
include("configs/config_static_data.php");
?>
...
<div class="max-w-7xl mx-auto px-4 py-8 space-y-8">
  <h1 class="text-3xl font-bold text-gray-800 tracking-tight">User Orders</h1>
...
<script>
  ...
  const API_ORDERS = `${BASE_URL}/admin/user_orders`;
  const API_USERS  = `${BASE_URL}/users`;              // adjust if different
