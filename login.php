    ...
    <div class="w-full md:w-1/2 px-4 md:px-10">
      <div class="bg-white rounded-xl p-8 md:p-10 shadow-lg max-w-md mx-auto">
        ...
        <form>
          ...
          <input type="email" placeholder="Email" class="w-full border border-gray-400 px-3 py-2 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-red-500" />
          <input type="password" placeholder="Password" class="w-full border border-gray-400 px-3 py-2 rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-red-500" />
        ...
        <p class="text-sm text-gray-600">Don't have an account? <a href="register.php" class="text-red-600 font-semibold">Sign up</a></p>
      </div>
    </div>
  </div>
</body>
