      ...
      <div class="bg-white rounded-xl p-8 md:p-8 shadow-lg max-w-2xl mx-auto">
        ...
        <form class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <input type="text" placeholder="Select Industries"
                class="w-full border border-gray-400 px-3 py-2 rounded-md" />
          ...
          <textarea placeholder="Complete Address" rows="3"
            class="w-full border border-gray-400 px-3 py-2 rounded-md resize-none"></textarea>
          ...
          <!-- Register Button -->
          <button type="submit"
            class="w-full bg-red-700 hover:bg-red-800 text-white font-semibold py-2 rounded-full mt-2">
            Register
          </button>
        </form>
        <br>
        <!-- Google Sign-up -->
        <button
          class="w-full border border-gray-300 flex items-center justify-center py-2 rounded-full mb-4 hover:shadow-md">
          <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google"
            class="w-5 h-5 mr-2">
          <span class="text-sm font-medium">Sign in with Google</span>
        </button>

        <p class="text-sm text-gray-600">already have an account? <a href="login.php"
            class="text-red-600 font-semibold">Sign in</a></p>
      </div>
    </div>
  </div>
</body>
